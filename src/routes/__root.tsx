...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Michele Rossetti — Digital Transformation & Full-Stack Developer" },
      {
        name: "description",
        content:
          "Portfolio of Michele Rossetti — Economics & Management graduate, Master's student in Digital Transformation at LUISS, full-stack developer based in Rome.",
      },
      { name: "author", content: "Michele Rossetti" },
      { property: "og:title", content: "Michele Rossetti — Portfolio" },
      {
      ...
      { property: "og:url", content: "https://rossettimichele.com" },
      { property: "og:site_name", content: "Michele Rossetti" },
      { property: "og:image", content: "https://rossettimichele.com/avatar.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "1200" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://rossettimichele.com/avatar.jpg" },
    ],
    links: [
